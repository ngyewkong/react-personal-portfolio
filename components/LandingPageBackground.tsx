...
function LandingPageBackground({}: Props) {
  return (
    ...
    >
      ...
      <div className="absolute border border-[#696969] rounded-full h-[450px] w-[450px] mt-52 animate-ping" />
      ...
      <div className="absolute border border-[#696969] rounded-full h-[900px] w-[900px] mt-52 animate-ping" />
    </motion.div>
  );
}
